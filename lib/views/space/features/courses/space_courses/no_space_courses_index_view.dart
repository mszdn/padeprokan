...
class NoSpaceCourses extends StatefulWidget {
  const NoSpaceCourses({super.key});

  @override
  State<NoSpaceCourses> createState() => _CoursesPageState();
}

class _CoursesPageState extends State<NoSpaceCourses> {
  @override
