...
import 'package:padeprokan/views/scheduled1/widgets/picker_day_item_widget.dart';
import 'package:padeprokan/views/scheduled1/widgets/week_days_widget.dart';
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    //   borderSide: BorderSide(color: violet.withOpacity(1)),
                    // ),
                    hintText: 'Event description (you can use markdown)',
                    hintStyle: const TextStyle(color: Colors.grey, fontSize: 16),
                  ),
